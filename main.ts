...
function fightScene1 (mySprite: Sprite) {
...
sprites.onOverlap(SpriteKind.empoweredPlayer, SpriteKind.Enemy, function (sprite, otherSprite) {
    color.startFade(color.originalPalette, color.Black, 2500)
    tiles.placeOnTile(sprite, tiles.getTileLocation(14, 5))
...
function fightScene12 (mySprite: Sprite) {
    ...
    statusbar.attachToSprite(null)
    statusbar.attachToSprite(Firstenemy)
}
