...
function QuizSubstraction (num1: number, num2: number) {
    substraction1 = game.askForNumber("Hello" + "World" + "")
    if (substraction1 == num1 - num2) {
        game.splash("Correct Answer!!")
        if (correctcounter >= 2) {
            pause(200)
            for (let index = 0; index < 2; index++) {
                damagecoin2 = sprites.createProjectileFromSprite(img`
                    . . . . . . . 5 . . . . . . . . 
                    . . . . . . 5 4 5 . . . . . . . 
                    . . . . . 5 4 4 4 5 . . . . . . 
                    . . . . 5 4 4 4 4 4 5 . . . . . 
                    ...
                    . 5 4 4 5 4 5 4 5 4 5 4 4 5 . . 
                    5 4 4 4 5 5 5 4 5 4 5 4 4 4 5 . 
                    . 5 4 4 4 4 5 4 5 4 5 4 4 5 . . 
            ...
            for (let index = 0; index < 2; index++) {
                statusbarMysprite.value += 20
            }
            pause(250)
            correctcounter += 1
            sprites.destroy(damagecoin2)
        }
    } else {
